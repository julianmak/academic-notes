...
\begin{proof}
  \begin{enumerate}
    ...
    \begin{align*}
      \int_{\gamma_2} f(z)\; \mathrm{d}z = \int^{b_2}_{a_2} f(\gamma_2(u)) \gamma_2'(u)\; \mathrm{d}u = \int^{b_1}_{a_1} f(\gamma_2(h(t))) \gamma_2'(h(t)) h'(t)\; \mathrm{d}t = \int^{b_1}_{a_1} f(\gamma_1(t)) \gamma_1'(t)\; \mathrm{d}t = \int_{\gamma_1} f(z)\; \mathrm{d}z.
    \end{align*}
    ...
    \begin{align*}
      \left|\int_\gamma f(z)\; \mathrm{d}z\right| &= \ex^{-\zi \theta} \int_\gamma f(z)\; \mathrm{d}z = \int_\gamma \ex^{-\zi \theta} f(z)\; \mathrm{d}z = \mbox{Re} \left(\int_\gamma \ex^{-\zi \theta} f(z)\; \mathrm{d}z\right) = \mbox{Re} \left(\int^b_a \ex^{-\zi \theta} f(\gamma(t)) \gamma'(t)\; \mathrm{d}t\right)\\
        &\leq \int^b_a \left|\ex^{-\zi \theta} f(\gamma(t)) \gamma'(t)\right|\; \mathrm{d}t = \int^b_a |f(\gamma(t))| \cdot |\gamma'(t)|\; \mathrm{d}t\\
