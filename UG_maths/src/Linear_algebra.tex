...
either, since it is \textbf{nilpotent} (of index 2; $\mathsf{A}^2 = 0$ here).}.
...
\begin{theorem}
  ...
  \mathsf{P}^T$.\sidenote{So orthogonal matrices are great, because a transpose
  is much easier to compute than the inverse.}
\end{theorem}
